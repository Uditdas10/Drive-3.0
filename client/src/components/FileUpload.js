...
//           data: formData,
//           headers: {
//             pinata_api_key: `f79bdeceb058a21a650f`,
//             pinata_secret_api_key: `8873665620f1c6365282dd45c40adc3fc9c2d7a1e05216f3e5fc7ed3d0b6f8ec`,
      ...
      if (file) {
        try {
          ...
          const resFile = await axios({
            ...
            data: formData,
            headers: {
              pinata_api_key: `66dc97dd66ea3d57b65c`,
              pinata_secret_api_key: `402522c38020884585e381aee317439f397698ed2a5aa45b84afde18f9da0780`,
              "Content-Type": "multipart/form-data",
            },
          });
